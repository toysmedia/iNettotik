...
<div class="row justify-content-center">
    ...
    <div class="col-md-8">
        ...
        <div class="alert alert-info d-flex align-items-center mb-4" role="alert">
            ...
            <div>
                <strong>Auto-generated by system:</strong> RADIUS Secret, PPPoE/Hotspot pools and network config are auto-generated by the system after creation.
            </div>
        </div>
                ...
                <form action="{{ route('admin.isp.routers.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="wan_ip" class="form-control @error('wan_ip') is-invalid @enderror"
                               value="{{ old('wan_ip') }}" placeholder="e.g. 41.215.10.5 (optional)">
                        <div class="form-text">Public/WAN IP of the MikroTik router. Used to register it in FreeRADIUS and for Winbox/Web links.</div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">IP tunnel/VPN address for connectivity between billing server and router. Used for API calls when set.</div>
