...
<div class="row justify-content-center">
    ...
    <div class="col-md-8">
        ...
        <div class="alert alert-info d-flex align-items-center mb-4" role="alert">
            ...
            <div>
                <strong>Auto-generated by system:</strong> RADIUS Secret, PPPoE/Hotspot pools and network config are auto-generated after creation. WAN IP and VPN IP are optional — set them now or update later via Edit.
            </div>
        </div>
                ...
                <form action="{{ route('admin.isp.routers.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="wan_ip" class="form-control @error('wan_ip') is-invalid @enderror"
                               value="{{ old('wan_ip') }}" placeholder="e.g. 102.212.246.157 (optional)">
                        <div class="form-text">Public IP of the router. Used for NAS registration and RADIUS. Leave blank to set later.</div>
